...
Route::get('/profile/{user}',[ProfileController::class,'edit'])->name('user.edit');
Route::put('/profile/{user}',[ProfileController::class,'update'])->name('user.update');
...
Route::get('/',[PostController::class,'topRated'])->name('home');
// view('posts.home');